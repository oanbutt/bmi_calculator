    ...
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: GestureDetector(
          onTap: (){
            CalculatorBrain cal =  CalculatorBrain(height: heightValue, weight: weightValue,age: ageValue,myColor: myColor,myColor1: myColor1);
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.only(top: 14,left: 20,right: 3,bottom: 15),
                      ...
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.only(top: 14,left: 3,right: 20,bottom: 15),
                          child: GestureDetector(
                            onTap: (){
                              setState(() {
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.only(top: 15,left: 20,right: 3,bottom: 24),
                          child: Container(
                            width: 150,
                            height: 180,
                            decoration: BoxDecoration(
                      ...
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.only(top: 15,left: 3,right: 20,bottom: 24),
                          child: Container(
                            width: 150,
                            height: 180,
                            decoration: BoxDecoration(
